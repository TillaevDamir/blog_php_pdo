...
foreach($nav as $k=>$val):?>
	<?php if($val['status_name'] === 'enable'): ?>
      <a class="p-2 text-muted" href="#"><?= $val['nav_name']; ?></a>
  <?php endif; ?>
<?php endforeach; ?>
    </nav>
  </div>
<?php if($_SERVER['REQUEST_URI'] == '/myblog/' || $_SERVER['REQUEST_URI'] == '/myblog' || $_SERVER['REQUEST_URI'] == '/myblog//'): ?>
...
<?php foreach($allPosts as $posts): ?>
      <div class="blog-post">
        ...
        <p><?= mb_strimwidth($posts['text'], 0, 500, '...');?> <a href="#">read more...</a></p>
    <?php endif; ?>
      </div><!-- /.blog-post -->
<?php endforeach; ?>
